const Card = ({ icon, title, desc, index }) => {
  ...
  return (
    <div
      className={`transition-transform duration-300 ease-in-out hover:scale-110 relative flex flex-col justify-between m-[1.2vw] md:m-[1vw] px-[3vw] md:px-[1vw] py-[5vw]  md:py-[1.6vw] w-[38vw] h-[38vw] md:w-[16vw] md:h-[16vw] bg-[#242222] ${cardStyles[index]}`}
    >
