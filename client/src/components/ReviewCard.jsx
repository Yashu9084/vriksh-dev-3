const ReviewCard = ({ profile, name, designation, description }) => {
    return (
      <div className="w-[400px] h-[300px] flex-shrink-0 flex flex-col justify-between m-2 p-4 bg-[#242222] border border-[#D9F203] rounded-md">
        <div className="flex flex-col text-white bg-transparent">
          <img className="bg-transparent mb-2" width={30} src={profile} alt="" />
