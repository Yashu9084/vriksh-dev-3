...
const Portfolio = () => {
  ...
  return (
    <div className="w-full mt-[8vw] px-[6vw] md:px-[3vw] py-[6vw] md:py-[3vw] bg-[#D9F203] font-sen">
      <div className="w-full p-[6vw] md:p-[3vw] bg-[#101010] flex flex-col gap-[vw] md:flex-row text-white">
        <div className="md:w-[40%] bg-transparent flex flex-col gap-[3vw] md:ap-[1.5vw] justify-center">
          <h1 className="bg-transparent  text-[8vw] md:text-[3vw] leading-[8vw] md:leading-[1.5vw]">Our Portfolio</h1>
          <p className="bg-transparent  text-[3.5vw] md:text-[0.9vw] leading-[6vw] md:leading-[1.2vw] text-[#909090]">
